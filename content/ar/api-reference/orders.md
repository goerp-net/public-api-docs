...
- **لا حجز مخزون** عند الإنشاء — المنتجات تتضمن مجاميع مخزون مدمجة؛ استخدم `variants[].availableQuantity`. للتفصيل حسب الموقع راجع `/v1/public/stock`
- استخدم **SKU المتغير** في `lines` — لا SKU المنتج
